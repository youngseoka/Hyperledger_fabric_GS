...
const (
	...
	digitalzone_nft_minterName = "digitalzone_nft_minter"
	digitalzone_nft_timestampName = "digitalzone_nft_timestamp"
	digitalzone_nft_uriName="digitalzone_nft_uri"
	test_youngseokOptionName = "test_youngseok"
	digitalzone_nft_categoryName="digitalzone_nft_category"
	digitalzone_nft_titleName="digitalzone_nft_title"
	digitalzone_nft_fcnName="digitalzone_nft_fcn"
	digitalzone_nft_numName="digitalzone_nft_num"
	digitalzone_nft_ownerName="digitalzone_nft_owner"
	digitalzone_settingName = "digitalzone_setting"
)
...
`,
	...
	Options: []cmds.Option{
		...
		cmds.StringOption(test_youngseokOptionName, "youngseok_test_add.go").WithDefault("with_default_add.go_youngseok"),
		cmds.StringOption(digitalzone_nft_minterName, "insert nft ID").WithDefault("digitalzone_nft_minterName"),
		cmds.StringOption(digitalzone_nft_timestampName, "insert chaincode time").WithDefault("digitalzone_nft_timestampName"),
		cmds.StringOption(digitalzone_nft_uriName, "insert chaincode time").WithDefault("digitalzone_uriName"),
		cmds.StringOption(digitalzone_nft_categoryName, "insert chaincode time").WithDefault("digitalzone_categoryName"),
		cmds.StringOption(digitalzone_nft_titleName, "insert chaincode time").WithDefault("digitalzone_titleName"),
		cmds.StringOption(digitalzone_nft_fcnName, "insert chaincode time").WithDefault("digitalzone_fcnName"),
		cmds.StringOption(digitalzone_nft_numName, "insert chaincode time").WithDefault("digitalzone_numName"),
		cmds.StringOption(digitalzone_nft_ownerName, "insert chaincode time").WithDefault("digitalzone_ownerName"),
		cmds.StringOption(digitalzone_settingName, "insert chaincode time").WithDefault("digitalzone_settingName"),
	...
	Run: func(req *cmds.Request, res cmds.ResponseEmitter, env cmds.Environment) error {
		...
		test_youngseok,_ :=req.Options[test_youngseokOptionName].(string)
		digitalzone_nft_minter,_ :=req.Options[digitalzone_nft_minterName].(string)
		digitalzone_nft_timestamp,_ :=req.Options[digitalzone_nft_timestampName].(string)
		digitalzone_nft_uri,_ :=req.Options[digitalzone_nft_uriName].(string)
		digitalzone_nft_category,_ :=req.Options[digitalzone_nft_categoryName].(string)
		digitalzone_nft_title,_ :=req.Options[digitalzone_nft_titleName].(string)
		digitalzone_nft_fcn,_ :=req.Options[digitalzone_nft_fcnName].(string)
		digitalzone_nft_num,_ :=req.Options[digitalzone_nft_numName].(string)
		digitalzone_nft_owner,_ :=req.Options[digitalzone_nft_ownerName].(string)
		digitalzone_setting,_ :=req.Options[digitalzone_settingName].(string)
		...
		opts := []options.UnixfsAddOption{
			...
			options.Unixfs.Test_youngseok(test_youngseok),
			options.Unixfs.Digitalzone_nft_minter(digitalzone_nft_minter),
			options.Unixfs.Digitalzone_nft_timestamp(digitalzone_nft_timestamp),
			options.Unixfs.Digitalzone_nft_uri(digitalzone_nft_uri),
			options.Unixfs.Digitalzone_nft_category(digitalzone_nft_category),
			options.Unixfs.Digitalzone_nft_title(digitalzone_nft_title),
			options.Unixfs.Digitalzone_nft_fcn(digitalzone_nft_fcn),
			options.Unixfs.Digitalzone_nft_num(digitalzone_nft_num),
			options.Unixfs.Digitalzone_nft_owner(digitalzone_nft_owner),
			options.Unixfs.Digitalzone_setting(digitalzone_setting),
		}
		...
		fmt.Println("cccccccccccccc : ", opts)
		...
		for addit.Next() {
			...
			for event := range events {
				...
				fmt.Println("core.commands.add.go")
				fmt.Println(output)
				const kkk = "sisisisisisisisi"
				if err := res.Emit(&AddEvent{
					...
					Digitalzone_setting:digitalzone_setting,
				}); err != nil {
					return err
				}
			}
