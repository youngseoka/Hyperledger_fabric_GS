...
pushd setup/vm1/
./createChannel_lowtech.sh
popd

sleep 5

pushd setup/vm2/
./joinChannel_lowtech.sh
popd
...
pushd setup/vm1/
./deployChaincode_trustID_init_lowtech.sh
popd

pushd setup/vm2/
./installAndApproveChaincode_trustID_lowtech.sh
popd
...
pushd setup/vm1/
./deployChaincode_trustID_insert_lowtech.sh
popd

pushd setup/vm1/
./deployChaincode_interval_random_init_lowtech.sh
popd

pushd setup/vm2/
./installAndApproveChaincode_Interval_random_lowtech.sh
popd
...
pushd setup/vm1/
./deployChaincode_interval_random_insert_lowtech.sh
popd
