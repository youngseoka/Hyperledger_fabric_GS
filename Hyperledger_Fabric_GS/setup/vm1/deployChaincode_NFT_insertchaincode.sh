...
--channelID "digitalzonenipanft" --name "token_erc721" \
...
chaincodeInvoke() {
	...
	--peerAddresses peer0.org3.example.com:11051 --tlsRootCertFiles /etc/hyperledger/channel/crypto-config/peerOrganizations/org3.example.com/peers/peer0.org3.example.com/tls/ca.crt \
  --peerAddresses peer0.org4.example.com:21051 --tlsRootCertFiles /etc/hyperledger/channel/crypto-config/peerOrganizations/org4.example.com/peers/peer0.org4.example.com/tls/ca.crt \
        -c '{"function": "Register_Item","Args":["youngseok1", "youngseok2","youngseok3","youngseok4"]}'
...
chaincodeInvoke_NFT() {
    ...
    docker exec cli peer chaincode invoke -o orderer.example.com:7050 \
        ...
        --peerAddresses peer0.org3.example.com:11051 --tlsRootCertFiles /etc/hyperledger/channel/crypto-config/peerOrganizations/org3.example.com/peers/peer0.org3.example.com/tls/ca.crt \
  --peerAddresses peer0.org4.example.com:21051 --tlsRootCertFiles /etc/hyperledger/channel/crypto-config/peerOrganizations/org4.example.com/peers/peer0.org4.example.com/tls/ca.crt \
        -c '{"function": "MintWithTokenURI","Args":["101", "https://youngseok.com/nft101.json"]}'
}
#chaincodeInvoke_NFT
...
chaincodeQuery() {
    setGlobalsForPeer0Org1
    peer chaincode query -C digitalzonenipanft -n token_erc721 -c '{"function": "OwnerOf","Args":["101"]}'
}
...
chaincodeInvoke_NFT() {
    ...
    docker exec cli peer chaincode invoke -o orderer.example.com:7050 \
        ...
        --peerAddresses peer0.org3.example.com:11051 --tlsRootCertFiles /etc/hyperledger/channel/crypto-config/peerOrganizations/org3.example.com/peers/peer0.org3.example.com/tls/ca.crt \
  --peerAddresses peer0.org4.example.com:21051 --tlsRootCertFiles /etc/hyperledger/channel/crypto-config/peerOrganizations/org4.example.com/peers/peer0.org4.example.com/tls/ca.crt \
        -c '{"function": "TransferFrom","Args":["'"$MINTER"'","'"$RECIPIENT"'","101"]}'
}
#chaincodeInvoke_NFT
