...
async function multipartRequest (source, abortController, headers = {}, boundary = `-----------------------------${nanoid()}`) {
  ...
  async function * streamFiles (source) {
    try {
      console.log("multipart-request.node.js")
      console.log(source)
      let index = 0
	...
	const corgicorgi = await toStream(streamFiles(source))

//	console.log("source : " + JSON.stringify(source))

	console.log("corgicorgi : " + JSON.stringify(corgicorgi))
 ...
 const corgicorgi2 = await toStream(streamFiles(source))
 console.log("corgicorgi2 : " + JSON.stringify(corgicorgi2))
