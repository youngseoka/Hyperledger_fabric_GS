...
(
  ...
  tokenuri varchar(255) DEFAULT NULL,
  token_id varchar(255) DEFAULT NULL,
  minter varchar(255) DEFAULT NULL,
  category varchar(255) DEFAULT NULL,
  title varchar(255) DEFAULT NULL,
  cid varchar(255) DEFAULT NULL,
  nft_num varchar(255) DEFAULT NULL,
  nft_status varchar(255) DEFAULT NULL,
  service_cert_num character varying DEFAULT NULL,
  service_cert_sort character varying DEFAULT NULL,
  service_buyer_did character varying DEFAULT NULL,
  service_seller_did character varying DEFAULT NULL,
  service_status character varying DEFAULT NULL,
  service_text character varying DEFAULT NULL,
  service_cert_sort_sub character varying DEFAULT NULL
);
...
--  Table structure for `transactions`
-- ----------------------------
DROP TABLE IF EXISTS transactions_lowtech;
CREATE TABLE transactions_lowtech
(
  id SERIAL PRIMARY KEY,
  blockid integer DEFAULT NULL,
  txhash character varying(256) DEFAULT NULL,
...
ALTER table transactions_lowtech owner to :user;
Alter sequence transactions_lowtech_id_seq restart with 6;


-- ----------------------------
--  Table structure for `transactions`
-- ----------------------------
DROP TABLE IF EXISTS transactions_nipanft;
CREATE TABLE transactions_nipanft
(
  id SERIAL PRIMARY KEY,
  blockid integer DEFAULT NULL,
  txhash character varying(256) DEFAULT NULL,
...
ALTER table transactions_nipanft owner to :user;
Alter sequence transactions_nipanft_id_seq restart with 6;
