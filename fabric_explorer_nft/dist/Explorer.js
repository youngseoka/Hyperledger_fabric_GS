    ...
    initialize(broadcaster) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const pltfrm of explorerconfig_json_1.default[ExplorerConst_1.explorerConst.PLATFORMS]) {
                ...
                passport_1.default.use('local-login', local_login_1.localLoginStrategy(platform));
                this.app.use('/api', auth_check_1.authCheckMiddleware);
                const authrouter = express_1.default.Router();
                // Initializing the rest app services
                yield authroutes_1.authroutes(authrouter, platform);
                const apirouter = express_1.default.Router();
                // Initializing the rest app services
                dbroutes_1.dbroutes(apirouter, platform);
                yield platformroutes_1.platformroutes(apirouter, platform);
                yield adminroutes_1.adminroutes(apirouter, platform);
