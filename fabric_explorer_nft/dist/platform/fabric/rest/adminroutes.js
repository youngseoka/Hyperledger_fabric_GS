...
function adminroutes(router, platform) {
    return __awaiter(this, void 0, void 0, function* () {
         ...
         */
        router.post('/register', requestutils_1.responder((req) => __awaiter(this, void 0, void 0, function* () {
         ...
         *
         */
        router.get('/userlist', requestutils_1.responder((req) => __awaiter(this, void 0, void 0, function* () {
         ...
         *
         */
        router.post('/unregister', requestutils_1.responder((req) => __awaiter(this, void 0, void 0, function* () {
            const reqUser = yield new User_1.User(req.body).asJson();
            reqUser.network = req.network;
            reqUser.requestUserId = req.requestUserId;
